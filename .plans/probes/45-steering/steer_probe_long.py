...
PROMPT_A = ("Write a detailed 2000-word essay on the history of the bicycle, from the draisine to the modern derailleur. "
            "Write the full essay in prose. Do not summarise; take your time.")
PROMPT_B = ("STOP. Abandon the essay immediately, mid-sentence if necessary. "
...
if state["first_assistant_text_at"] is None:
    ...
    time.sleep(8.0)  # deep into the essay stream: mid-turn is unambiguous
