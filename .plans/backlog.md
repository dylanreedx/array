...
Program history: `docs/38-tickets/95-go-live.md`. **Shipped state: 0.4.2 (build 8),
live on arrayapp.dev 2026-08-11; next release is build 9.** `main` ==
...
## Shipped in 0.4.0 – 0.4.2 (builds 6–8, 2026-08-10/11)
