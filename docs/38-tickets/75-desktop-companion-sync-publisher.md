...
Status: **ready / rewritten implementation, 2026-07-07.** Tickets `79-pair-to-instance-auth-boundary.md` and `80-companion-offline-freshness.md` have landed. Implement this only as a paired-instance publisher with freshness metadata; do **not** implement the old same-iCloud-as-authority version.
