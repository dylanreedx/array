...
final class ApprovalDockView: NSView {
    ...
    override init(frame frameRect: NSRect) {
        ...
        let approve = makeButton(title: "Approve", decision: .approve, orange: true)
        let approveSession = makeButton(title: "Approve for session", decision: .approveForSession, orange: true)
    ...
    @objc private func decisionClicked(_ sender: NSButton) {
        ...
        case ApprovalDecision.approve.rawValue:
            qaClick(.approve)
        case ApprovalDecision.approveForSession.rawValue:
            qaClick(.approveForSession)
