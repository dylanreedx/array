...
func runStrictAgentHarnessChecks() throws {
    ...
    for depth in [0, 1] {
        ...
        try expect(args == ["--tools", "read, grep, spawn_agent, wait_agents, delegate_agent, array_workspace_context, array_open_document, array_find_agent, array_inspect_agent, array_canvas_query, array_canvas_apply"],
    ...
    try expect(cappedArgs == ["--tools", "read, grep, array_workspace_context, array_open_document, array_find_agent, array_inspect_agent, array_canvas_query, array_canvas_apply"],
