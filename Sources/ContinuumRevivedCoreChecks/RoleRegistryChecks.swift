...
func runRoleRegistryHarnessConvergenceChecks() throws {
    ...
    // CX-01 (`.plans/59`): Array's host bridge tools are appended for every roled
    // pi agent regardless of depth — reading your own context and opening a file
    ...
    expect(pi.toolsArguments(roleId: "pi-orchestrator", allowingSpawn: false) == ["--tools", "read, grep, array_workspace_context, array_open_document, array_find_agent, array_inspect_agent, array_canvas_query, array_canvas_apply, array_delegate, array_reveal_agent, array_get_operation"],
    ...
    expect(pi.toolsArguments(roleId: "pi-orchestrator", allowingSpawn: true)
            == ["--tools", "read, grep, spawn_agent, wait_agents, delegate_agent, array_workspace_context, array_open_document, array_find_agent, array_inspect_agent, array_canvas_query, array_canvas_apply, array_delegate, array_reveal_agent, array_get_operation"],
    ...
    expect(respawned.toolsArguments(roleId: "pi-spawner", allowingSpawn: true)
            == ["--tools", "read, spawn_agent, wait_agents, delegate_agent, array_workspace_context, array_open_document, array_find_agent, array_inspect_agent, array_canvas_query, array_canvas_apply, array_delegate, array_reveal_agent, array_get_operation"],
    ...
    expect(both.toolsArguments(roleId: "pi-both", allowingSpawn: true)
            == ["--tools", "read, delegate_agent, spawn_agent, wait_agents, array_workspace_context, array_open_document, array_find_agent, array_inspect_agent, array_canvas_query, array_canvas_apply, array_delegate, array_reveal_agent, array_get_operation"],
