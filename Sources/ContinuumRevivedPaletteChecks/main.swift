...
expect(rows.map(\.displayName) == ["Shell", "Claude CLI Terminal", "New Agent…", "New Agent Without a Tile…", "New Note", "New Browser", "Open File...", "Open File Tree...", "New Diff Review", "Fit Canvas to All", "Back to Previous View", "Go to Previous Tile", "Go to Previous Zone", "Toggle Workspace Sidebar", "New Workspace…", "Create Zone…"], "palette appends note/browser/file/file-tree/diff/fit/workspace actions after profiles, then Create Zone")
...
expect(LaunchPaletteModel.filterRows(rows, query: "agent").map(\.displayName) == ["New Agent…", "New Agent Without a Tile…"], "agent query matches the two agent actions in declared order (tile-bound first), not raw CLI profiles")
...
expect(harnessRows.map(\.displayName) == ["New Agent…", "New Agent Without a Tile…", "New Note", "New Browser", "Open File...", "Open File Tree...", "New Diff Review", "Fit Canvas to All", "Back to Previous View", "Go to Previous Tile", "Go to Previous Zone", "Toggle Workspace Sidebar", "New Workspace…", "Run QA Reviewer Agent…", "Create Zone…"], "palette appends harness role actions after built-in actions, then Create Zone")
...
expect(jumpRows.map(\.displayName) == ["New Agent…", "New Agent Without a Tile…", "New Note", "New Browser", "Open File...", "Open File Tree...", "New Diff Review", "Fit Canvas to All", "Back to Previous View", "Go to Previous Tile", "Go to Previous Zone", "Toggle Workspace Sidebar", "New Workspace…", "Jump to API Server", "Jump to Notes", "Create Zone…"], "palette appends Jump-to-tile rows after the built-in actions, then Create Zone")
...
let builtIns7 = ["New Agent…", "New Agent Without a Tile…", "New Note", "New Browser", "Open File...", "Open File Tree...", "New Diff Review", "Fit Canvas to All", "Back to Previous View", "Go to Previous Tile", "Go to Previous Zone", "Toggle Workspace Sidebar", "New Workspace…"]
...
expect(projectRows.map(\.displayName) == ["New Agent…", "New Agent Without a Tile…", "New Note", "New Browser", "Open File...", "Open File Tree...", "New Diff Review", "Fit Canvas to All", "Back to Previous View", "Go to Previous Tile", "Go to Previous Zone", "Toggle Workspace Sidebar", "New Workspace…", "Create Zone…", "Add Work Project to Canvas"], "palette appends Create Zone then add-project rows")
...
expect(workspaceRows.map(\.displayName) == ["New Agent…", "New Agent Without a Tile…", "New Note", "New Browser", "Open File...", "Open File Tree...", "New Diff Review", "Fit Canvas to All", "Back to Previous View", "Go to Previous Tile", "Go to Previous Zone", "Toggle Workspace Sidebar", "New Workspace…", "Create Zone…", "Switch to Client Work Workspace", "Rename Client Work Workspace…", "Delete Client Work Workspace…"], "palette appends Create Zone then workspace rows")
...
// Index [13] = Create Zone… (selectable), [14] = Switch to Empty Workspace (not selectable because empty).
...
expect(missingRows[13].isSelectable, "Toggle Workspace Sidebar action row is selectable")
expect(missingRows[14].isSelectable, "New Workspace action row is selectable")
